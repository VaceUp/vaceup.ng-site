...
export const Hero: React.FC<HeroProps> = ({ onOpenAuth }) => {
  const stats = [
    { value: '30', label: 'Student trained' },
    { value: '5', label: 'Expert instructors' },
    { value: '8', label: 'Courses / Programes' },
    { value: '98%', label: 'Student satisfaction' },
    { value: '3', label: 'Country reached' },
  ];

  return (
    <div className="w-full">
      {/* Upper Dark Navy Hero Block */}
      <section className="relative overflow-hidden bg-[#00088A] pt-12 pb-16 md:pt-16 md:pb-20 lg:pt-20 lg:pb-24 text-white">
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
            ...
            <div className="flex flex-col items-start lg:col-span-7">
              ...
              <h1 className="mt-6 text-4xl font-black tracking-tight text-white sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl leading-[1.1]">
                Learn. Apply. <span className="text-[#FFC72C]">Earn.</span> <br />
                Succeed.
              </h1>
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto">
                <a
                  href="#courses"
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#FFC72C] px-8 py-3.5 text-sm sm:text-base font-bold text-[#00088A] shadow-md transition-all hover:bg-[#ebd024] hover:shadow-lg active:scale-95"
                >
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-4 border-t border-white/10 pt-6 w-full">
                <div className="flex -space-x-3 overflow-hidden">
                  <img
                    className="inline-block h-10 w-10 rounded-full ring-2 ring-[#00088A] object-cover"
      ...
      <section className="bg-[#EBF3F5] py-10 sm:py-12 md:py-16 border-b border-gray-200">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-2 gap-8 text-center sm:grid-cols-3 lg:grid-cols-5 lg:gap-4">
            {stats.map((stat, index) => (
              <div key={index} className="flex flex-col items-center justify-center">
                <span className="text-3xl font-extrabold text-[#00088A] sm:text-4xl md:text-5xl lg:text-6xl tracking-tight">
                  {stat.value}
                </span>
                <span className="mt-2 text-xs sm:text-sm font-medium text-[#00088A]/80">
                  {stat.label}
                </span>
              </div>
            ))}
